...
# Random Forest
set.seed(547)
rf_model <- train(ph ~ ., data = train, method = "rf", trControl = control)
...
cubist_model <- train(ph ~ ., data = train, method = "cubist", trControl = control)

# Make predictions on the test set
cubist_predictions <- predict(cubist_model, newdata = test)
